                    ...
                    {result ? (
                        ...
                        <div className="bg-white p-10 rounded-3xl border shadow-sm">
                            ...
                            <div className="space-y-6">
                                ...
                                <button onClick={handleRun} disabled={loading} className="w-full bg-indigo-600 text-white font-black py-5 rounded-2xl text-lg hover:bg-black transition-all transform active:scale-95 shadow-xl shadow-indigo-100">
