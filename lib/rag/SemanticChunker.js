...
class SemanticChunker {
     ...
     * @param {Object} metadata - Metadata a añadir a cada chunk
     * @returns {Array<Object>} Chunks con texto, metadata e índice
     */
    chunk(text, metadata = {}) {
     ...
     * Divide respetando estructura de semana/día/pomodoro.
     * @param {Object} weekData - Datos de una semana
     * @returns {Array<Object>}
     */
    chunkCurriculum(weekData) {
        const chunks = [];
        let globalIndex = 0;
     ...
     * @returns {Array}
     */
    addContextWindow(chunks, windowSize = 1) {
